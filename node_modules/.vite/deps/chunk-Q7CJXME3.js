...
var MintCloseAuthorityLayout = (0, import_buffer_layout22.struct)([publicKey("closeAuthority")]);
...
var PermanentDelegateLayout = (0, import_buffer_layout24.struct)([publicKey("delegate")]);
...
function transferFeeLayout(property) {
  return (0, import_buffer_layout26.struct)([u64("epoch"), u64("maximumFee"), (0, import_buffer_layout26.u16)("transferFeeBasisPoints")], property);
}
...
var TransferFeeAmountLayout = (0, import_buffer_layout26.struct)([u64("withheldAmount")]);
...
// node_modules/@solana/spl-token/lib/esm/extensions/transferHook/state.js
var TransferHookLayout = (0, import_buffer_layout28.struct)([publicKey("authority"), publicKey("programId")]);
...
async function addExtraAccountsToInstruction(connection, instruction, mint, commitment, programId = TOKEN_PROGRAM_ID) {
  if (!programSupportsExtensions(programId)) {
    throw new TokenUnsupportedInstructionError();
  }
...
async function createTransferCheckedWithTransferHookInstruction(connection, source, mint, destination, authority, amount, decimals, multiSigners = [], commitment, programId = TOKEN_PROGRAM_ID) {
...
async function createTransferCheckedWithFeeAndTransferHookInstruction(connection, source, mint, destination, authority, amount, decimals, fee, multiSigners = [], commitment, programId = TOKEN_PROGRAM_ID) {
...
init_index_browser_esm();
var mintToInstructionData = (0, import_buffer_layout36.struct)([(0, import_buffer_layout36.u8)("instruction"), u64("amount")]);
...
init_index_browser_esm();
var transferInstructionData = (0, import_buffer_layout41.struct)([(0, import_buffer_layout41.u8)("instruction"), u64("amount")]);
...
function createUiAmountToAmountInstruction(mint, amount, programId = TOKEN_PROGRAM_ID) {
  ...
  const uiAmountToAmountInstructionData = (0, import_buffer_layout42.struct)([
    (0, import_buffer_layout42.u8)("instruction"),
    (0, import_buffer_layout42.blob)(buf.length, "amount")
  ]);
...
function decodeUiAmountToAmountInstruction(instruction, programId = TOKEN_PROGRAM_ID) {
  ...
  const uiAmountToAmountInstructionData = (0, import_buffer_layout42.struct)([
    (0, import_buffer_layout42.u8)("instruction"),
    (0, import_buffer_layout42.blob)(instruction.data.length - 1, "amount")
  ]);
...
function decodeUiAmountToAmountInstructionUnchecked({ programId, keys: [mint], data }) {
  const uiAmountToAmountInstructionData = (0, import_buffer_layout42.struct)([
    (0, import_buffer_layout42.u8)("instruction"),
    (0, import_buffer_layout42.blob)(data.length - 1, "amount")
  ]);
  return {
    programId,
    keys: {
...
function getStructEncoder(fields) {
  ...
  return createEncoder({
    ...
    write: (struct50, bytes, offset) => {
      fields.forEach(([key, codec]) => {
        offset = codec.write(struct50[key], bytes, offset);
      });
      return offset;
    }
  });
...
function decodeInstruction(instruction, programId = TOKEN_PROGRAM_ID) {
  if (!instruction.data.length)
    throw new TokenInvalidInstructionDataError();
  const type = (0, import_buffer_layout48.u8)().decode(instruction.data);
...
function createReallocateInstruction(account, payer, extensionTypes, owner, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
  ...
  const reallocateInstructionData = (0, import_buffer_layout51.struct)([
    (0, import_buffer_layout51.u8)("instruction"),
    (0, import_buffer_layout51.seq)((0, import_buffer_layout51.u16)(), extensionTypes.length, "extensionTypes")
  ]);
...
//# sourceMappingURL=chunk-Q7CJXME3.js.map
